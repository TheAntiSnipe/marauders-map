"""This is a script for people who want to use leaflet's tile overlay. So far,
I haven't been able to get it to work, but you'll need this coordinate system
in order to properly render the map.
...
for x in range(-10, 10):
    for y in range(-10, 10):
        ...
        modifiedFilepath = './leaflet-compliant-coordinates/tile-' + \
            str(x)+'_'+str(-y)+'.jpg'
